...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response) {
        ...
        setTimeout(() => {
          window.location.replace("/voir-todo");
        }, 3000);
      } else {
  ...
  return (
    <>
      <div className="w-full mt-5 flex flex-col justify-center sm:py-12">
                  ...
                  <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                    <div className="relative">
                      <input
                        ...
                        id="email"
                        name="email"
                        type="email" // Utilise "email" pour une meilleure validation
